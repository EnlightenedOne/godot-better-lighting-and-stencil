...
float sample_directional_shadow(uint i, hvec3 vertex) {
	...
	if (directional_lights.data[i].bake_mode == LIGHT_BAKE_STATIC && bool(instances.data[i].flags & INSTANCE_FLAGS_USE_LIGHTMAP)) {
